 ...
 */
internal class SNTBlockScalarItemBlock private constructor(
    ...
    companion object {
         ...
         */
        fun createBlockScalarItem(context: SNTFormattingContext, node: ASTNode): Block {
            ...
            return SNTBlockScalarItemBlock(range, indent, alignment)
        }

        private fun getFirstLineOffset(context: SNTFormattingContext, blockScalarPsi: YAMLBlockScalarImpl): Int {
            val parentFullIndent =
                getParentFullIndent(
                    context,
        ...
        private fun getParentFullIndent(context: SNTFormattingContext, node: ASTNode): Int {
